		...
		while (true) {
			...
			while (true) {
				...
				if (opcion == 2) {
					...
					System.out.println("El telefono de la persona " + nombrePersona + " es " + agenda.get(nombrePersona));
					break;
				}
				// Lista Agenda
				else if (opcion == 3){
					...
					while (true) {
						...
						System.out.println("Ingrese numero de celular. Codigo de área + numero -sin el 15-. Total 9 digitos");
