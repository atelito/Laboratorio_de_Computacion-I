...
ARRAY3 = (posición 0 del arreglo 1 * posición 0 del arreglo 2) +
        ...
        */
        ...
        int[] arreglo1 = getArregloIntConDimension(dimC);
        int[] arreglo2 = getArregloIntConDimension(dimC2);

        //imprimirArregloIntEnLinea(arreglo1, arreglo1.length);
        //imprimirArregloIntEnLinea(arreglo2, arreglo2.length);
        
        int [] arreglo3 = new int [dimC2];
